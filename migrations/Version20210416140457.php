 ...
 */
final class Version20210416140457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `Order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, reference VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, carrier_name VARCHAR(255) NOT NULL, carrier_price DOUBLE PRECISION NOT NULL, delivery_address LONGTEXT NOT NULL, is_paid TINYINT(1) NOT NULL, more_information LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, quantity INT NOT NULL, subtotalht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, subtotalttc DOUBLE PRECISION NOT NULL, INDEX IDX_34E8BC9CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
